...
// Option 1: Via Backend Central (recommandé) → http://localhost:4000/api/qatar
// Option 2: Accès direct au backend → http://localhost:3001
...
console.log(`✅ Hearst Control API: ${API_URL}`);
