...
// Configuration API - Flexible pour développement
// Option 1: Via Backend Central (recommandé) → http://localhost:4000/api/srq
// Option 2: Accès direct au backend → http://localhost:3003
...
console.log(`✅ SRQ API configurée sur: ${API_URL}`);
